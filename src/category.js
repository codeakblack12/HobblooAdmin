...
import EditCategory from './categoryPages/editCategory';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{alignItems: "center", justifyContent: "center", flex: 1, zIndex: 1}}>
        {activityvalue=="add"?(<AddCategory/>):(activityvalue=="edit"?(<EditCategory/>):(<Text style={{fontSize: 15, color: "black"}}>Please select an activity!</Text>))}
      </View>
    </View>
  );
}
